"""
spacecraft_model.py - Modello dinamico del satellite EXCITE
...
Migrato da simulation/EXCITE_Dynamics.py con import da excite.config.*
"""
...
# Import EXCITE configuration modules
from excite.config import spacecraft as sc_config
from excite.config import actuators as act_config
from excite.config import sensors as sens_config
from excite.config import environment as env_config
from excite.config import constants as const
